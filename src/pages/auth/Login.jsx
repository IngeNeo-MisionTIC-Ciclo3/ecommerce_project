  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 py-2 bg-gray-50 sm:px-6 lg:px-8">
      ...
      <div className="flex items-center justify-center">
        <h2 className="my-4 text-sm font-extrabold text-center text-gray-900"> Con </h2>
      </div>
      <div className="w-full max-w-md">
        <div>
          <button type="submit" className="relative flex justify-center w-full px-4 py-2 text-sm font-medium text-gray-700 bg-gray-200 border border-transparent rounded-md group hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
        ...
        <div className="w-full max-w-md my-2">
          <div>
            <button type="submit" className="relative flex justify-center w-full px-4 py-2 text-sm font-medium text-gray-700 bg-gray-200 border border-transparent rounded-md group hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
              <div className="flex items-center justify-start">
                <img src={Facebook} alt="Logo Google" className="w-6 h-6" />
                <span className="mx-4">Continúa con Facebook</span>
              </div>
            </button>
          </div>
        </div>
