	...
	return (
		<div className="container mx-auto mt-5 text-center">
			...
			<table className="border-2 border-blue-500 border-opacity-75 table-fixed md:border-opacity-50">
				<thead>
					<tr>
						<th className="px-4 py-2 text-blue-900 border border-blue-600">
							ID
						</th>
						<th className="px-4 py-2 text-blue-900 border border-blue-600">
							Nombre del Cliente
				...
				<tbody>
					<tr className="bg-blue-200">
						<th className="w-auto px-1 py-1 border border-gray-200">
							60987761
						</th>
						<th className="w-auto px-1 py-1 border border-gray-200">
							John Tyler
						...
						<th className="w-auto px-1 py-1 border border-blue-600">
							Despachado
						</th>
						<th className="grid grid-flow-col grid-cols-1 gap-4 px-4 py-2 bg-green-600 border border-green-900 opacity-100 place-content-stretch">
							Modificar
						</th>
					</tr>
					...
					<tr>
						...
						<th className="grid grid-flow-col grid-cols-1 gap-8 px-1 py-1 bg-green-600 border border-green-900 opacity-100 place-content-stretch">
							Modificar
						</th>
					</tr>
				</tbody>
